...
function quizTypeOne(){
	...
	function prepareVerbs(){
		...
		function regularness(set){ //check regularity
		...
		function reflexiveness(set){ //check reflexivity
		...
		function separabilitycheck(set){
